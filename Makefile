BASE = ../../../
FCMAKE = D:/Program Files/FITkit/bin/fcmake.exe
FKFLASH = D:/Program Files/FITkit/bin/fkflash.exe
FKTERM = D:/Program Files/FITkit/bin/fkterm.exe
FKTEST = D:/Program Files/FITkit/bin/fktest.exe
PROJECT = project.xml
OUTPUTPREFIX = inp
FPGACHIP = xc3s50
FPGASPEEDGRADE = 4
